...
interface BaseAuthenticator {
    ...
    //will allow us to implement any type of authentication api may it be, abstraction layer so application
    //will not know what authentication service its using
